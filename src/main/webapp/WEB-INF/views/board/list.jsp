...
<body>
	...
	<div class="container pt-5">		
			...
			<table class="table table-hover">
			  ...
			  <tbody>
			  	<c:forEach items="${boardList}" var="board"  varStatus="status">
				      ...
				      <td><a href ="/board/${menuType}/${board.boardSeq}"> ${board.title} </a></td>    
			...
			<div class="d-grid gap-2 d-md-flex justify-content-md-end mt-3">
			  <a href="/board/${menuType}/form" class="btn btn-primary me-md-2" type="button"><spring:message code="button.form"/></a>
			</div>
	</div>
